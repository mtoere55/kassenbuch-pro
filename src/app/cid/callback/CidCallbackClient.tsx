...
export function CidCallbackClient() {
  ...
  const validCid = isValidCid(cid);
  const message = validCid
    ? "CID wurde übernommen. Kassenbuch Pro wird geöffnet …"
    : "Keine gültige CID in der Cidentia Rückgabe gefunden.";
