...
function displayAccountCode(entry: LedgerEntry): string { if ((entry.direction === "transfer" || entry.sourceId?.startsWith("unitel-sales:")) && entry.counterAccountCode) return entry.counterAccountCode; return entry.accountCode || entry.category.match(/^(\d{4})/)?.[1] || "-"; }
